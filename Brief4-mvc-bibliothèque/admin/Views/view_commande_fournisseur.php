<form class="formConnexAjout" method="post" action="?controller=commande&action=fournisseur_all_commande">

<div class="formDiv">
    <label class="labelForm" for="nom">Recherche de commande par éditeur : </label><br>
    <?php
    echo '<select class="form" required="required" placeholder="Titre" type="text" name="fournisseur">';
    foreach ($commandes as $f):
